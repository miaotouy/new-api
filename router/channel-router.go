...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/test/:id/config", permission: authz.ChannelOperate, handler: controller.GetChannelTestConfig},
	{method: http.MethodPut, path: "/test/:id/config", permission: authz.ChannelWrite, handler: controller.UpdateChannelTestConfig},
	{method: http.MethodGet, path: "/test/:id", permission: authz.ChannelOperate, handler: controller.TestChannel},
	{method: http.MethodPost, path: "/test/:id", permission: authz.ChannelOperate, handler: controller.TestChannelWithRequest},
